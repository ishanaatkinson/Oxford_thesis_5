...
#write.csv(overall_sim_results,"C:/Users/STUDENT_NAME/Documents/!_Placement Research/Data/30cov/sim_results.csv", row.names = FALSE)
...
#write.csv(overall_sim_results_pq3,"C:/Users/STUDENT_NAME/Documents/!_Placement Research/Data/30cov/sim_results_pq3.csv", row.names = FALSE)

# taf mda
overall_sim_results_taf3 = do.call(cbind, model_sim_results_taf3)
#write.csv(overall_sim_results_taf3,"C:/Users/STUDENT_NAME/Documents/!_Placement Research/Data/30cov/sim_results_taf3.csv", row.names = FALSE)

# 5 rounds

#PQ mda
overall_sim_results_pq5 = do.call(cbind, model_sim_results_pq5)
#write.csv(overall_sim_results_pq5,"C:/Users/STUDENT_NAME/Documents/!_Placement Research/Data/30cov/sim_results_pq5.csv", row.names = FALSE)

# taf mda
overall_sim_results_taf5 = do.call(cbind, model_sim_results_taf5)
#write.csv(overall_sim_results_taf5,"C:/Users/STUDENT_NAME/Documents/!_Placement Research/Data/30cov/sim_results_taf5.csv", row.names = FALSE)

# 7 rounds

#PQ mda
overall_sim_results_pq7 = do.call(cbind, model_sim_results_pq7)
#write.csv(overall_sim_results_pq7,"C:/Users/STUDENT_NAME/Documents/!_Placement Research/Data/30cov/sim_results_pq7.csv", row.names = FALSE)

# taf mda
overall_sim_results_taf7 = do.call(cbind, model_sim_results_taf7)
#write.csv(overall_sim_results_taf7,"C:/Users/STUDENT_NAME/Documents/!_Placement Research/Data/30cov/sim_results_taf7.csv", row.names = FALSE)
