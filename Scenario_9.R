...
#model
overall_sim_results = read_csv(paste0("https://raw.githubusercontent.com/student1445449/MGH_thesis_", coverage, "cov_lowavail/main/sim_results.csv"), show_col_types = FALSE)
# 3 rounds

#PQ mda
overall_sim_results_pq3 = read_csv(paste0("https://raw.githubusercontent.com/student1445449/MGH_thesis_", coverage, "cov_lowavail/main/sim_results_pq3.csv"), show_col_types = FALSE)

# taf mda
overall_sim_results_taf3 = read_csv(paste0("https://raw.githubusercontent.com/student1445449/MGH_thesis_", coverage, "cov_lowavail/main/sim_results_taf3.csv"), show_col_types = FALSE)

# 5 rounds

#PQ mda
overall_sim_results_pq5 = read_csv(paste0("https://raw.githubusercontent.com/student1445449/MGH_thesis_", coverage, "cov_lowavail/main/sim_results_pq5.csv"), show_col_types = FALSE)
# taf mda
overall_sim_results_taf5 = read_csv(paste0("https://raw.githubusercontent.com/student1445449/MGH_thesis_", coverage, "cov_lowavail/main/sim_results_taf5.csv"), show_col_types = FALSE)
# 7 rounds

#PQ mda
overall_sim_results_pq7 = read_csv(paste0("https://raw.githubusercontent.com/student1445449/MGH_thesis_", coverage, "cov_lowavail/main/sim_results_pq7.csv"), show_col_types = FALSE)
# taf mda
overall_sim_results_taf7 = read_csv(paste0("https://raw.githubusercontent.com/student1445449/MGH_thesis_", coverage, "cov_lowavail/main/sim_results_taf7.csv"), show_col_types = FALSE)
...
model_upper<-sum(conf_int_u[1300:1663])
model_lower<-sum(conf_int_l[1300:1663])

MDA_pq3<-sum((df1_pq3 %>%filter(variable %in% c("LocDiag"), time>1299))$value)
MDA_upper_pq3<-sum(conf_int_u_pq3[1300:1663]) 
MDA_lower_pq3<-sum(conf_int_l_pq3[1300:1663])

MDA_pq5<-sum((df1_pq5 %>%filter(variable %in% c("LocDiag"), time>1299))$value)
MDA_upper_pq5<-sum(conf_int_u_pq5[1300:1663]) 
MDA_lower_pq5<-sum(conf_int_l_pq5[1300:1663])

MDA_pq7<-sum((df1_pq7 %>%filter(variable %in% c("LocDiag"), time>1299))$value)
MDA_upper_pq7<-sum(conf_int_u_pq7[1300:1663]) 
MDA_lower_pq7<-sum(conf_int_l_pq7[1300:1663])

MDA_taf3<-sum((df1_taf3 %>%filter(variable %in% c("LocDiag"), time>1299))$value)
MDA_upper_taf3<-sum(conf_int_u_taf3[1300:1663]) 
MDA_lower_taf3<-sum(conf_int_l_taf3[1300:1663])

MDA_taf5<-sum((df1_taf5 %>%filter(variable %in% c("LocDiag"), time>1299))$value)
MDA_upper_taf5<-sum(conf_int_u_taf5[1300:1663]) 
MDA_lower_taf5<-sum(conf_int_l_taf5[1300:1663])

MDA_taf7<-sum((df1_taf7 %>%filter(variable %in% c("LocDiag"), time>1299))$value)
MDA_upper_taf7<-sum(conf_int_u_taf7[1300:1663]) 
MDA_lower_taf7<-sum(conf_int_l_taf7[1300:1663])
